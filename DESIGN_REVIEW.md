...
- Homepage: a cinematic night-sky opening, oversized “Clarity runs deep” typography, full-width field photography, a documented Newberry Volcano interpretation, a compact 2025 Ivy project reference, a ZT-100B product feature, photographic application links, company history, and the next event.
...
- Contact: the inquiry form leads on desktop and phones. A compact page heading brings the first field into the initial viewport; office information sits alongside on desktop and below the form on phones. Selected instrument categories automatically scroll into view within the horizontal strip.
...
The first two suites below validated the preceding design revision. This follow-up reran targeted checks for the contact, category, and project-evidence changes, plus the complete static validation and both builds.
