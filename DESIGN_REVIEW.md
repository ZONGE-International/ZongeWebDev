...
- Technical pages: a software page organized into four task groups containing all 12 existing programs; an authentic Steptoe MT response figure; a geothermal introduction with the full published Newberry gravity map; concise ZT-100B introductory copy and power options; and navigation within longer pages.
